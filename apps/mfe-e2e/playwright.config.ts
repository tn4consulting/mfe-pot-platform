...
export default defineConfig({
  ...
  // job-bank + job-bank-bff removed from this array: they've moved to
  // mfe-pot-job-bank (Phase 1 of the polyrepo split, see
  // docs/plans/20260801-1935-mfe-pot-polyrepo-split-and-k8s-hosting.md) and
  // no longer exist as projects in this workspace. Phase 2 rewires every
  // remaining entry here to point at each app's sibling checkout once all
  // 5 are extracted, rather than patching this file once per extraction --
  // until then, this suite has no job-bank coverage.
  webServer: [
